document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getFieldError(field) {
      ...
      if (field.minLength && field.minLength > 0 && value.length > 0 && value.length < field.minLength) {
  ...
  const ANIMATION_SELECTOR  = '.fade-in, .animate-on-scroll, [data-animate]';
  const INTERSECTION_RATIO  = 0.15;

  function applyScrollAnimations() {
    const animatableEls = document.querySelectorAll(ANIMATION_SELECTOR);
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "פיצה צ'יזי לוק משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '84d53d7c-98df-4501-b050-da0e0e5ef234',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '84d53d7c-98df-4501-b050-da0e0e5ef234';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '84d53d7c-98df-4501-b050-da0e0e5ef234';
